<?php
  ...
  $stateList = array("Andaman and Nicobar Islands", "Andhra Pradesh", "Arunachal Pradesh", "Assam", "Bihar", "Chandigarh", "Chhattisgarh", "Dadra and Nagar Haveli", "Daman and Diu", "Delhi", "Goa", "Gujarat", "Haryana", "Himachal Pradesh", "Jammu and Kashmir", "Jharkhand", "Karnataka", "Kerala", "Lakshadweep", "Madhya Pradesh", "Maharashtra", "Manipur", "Meghalaya", "Mizoram", "Nagaland", "Orissa", "Pondicherry", "Punjab", "Rajasthan", "Sikkim", "Tamil Nadu", "Tripura", "Uttaranchal", "Uttar Pradesh", "West Bengal");
   ...
   if (!empty($_POST)) {
      ...
      $errorList = array("titleErr" => "", "firstNameErr" => "", "middleNameErr" => "", "lastNameErr" => "", "emailErr" => "", "phoneErr" => "", "genderErr" => "", "dobErr" => "", "resStreetErr" => "", "resCityErr" => "", "resZipErr" => "", "resStateErr" => "", "marStatusErr" => "", "empStatusErr" => "", "employerErr" => "", "commViaErr" => "", "noteErr" => "", "imageErr" => "", "ofcStreetErr" => "", "dobErr" => "", "ofcCityErr" => "", "ofcZipErr" => "", "ofcStateErr" => "");
     }
   ...
   if(isset($_GET['edit'])) {
      $update = 1;
      $empId = $_GET['edit'];
      $selectQuery = "SELECT Employee.empId, Employee.title, Employee.firstName, Employee.middleName, Employee.lastName, Employee.email, Employee.phone, Employee.gender, Employee.dateOfBirth, Residence.street AS resStreet, Residence.city AS resCity , Residence.zip AS resZip, Residence.state AS resState, Office.street AS ofcStreet, Office.city AS ofcCity , Office.zip AS ofcZip, Office.state AS ofcState, Employee.maritalStatus, Employee.empStatus, Employee.image, Employee.employer, Employee.commId, Employee.note
      FROM Employee 
                        ...
                        <div class="row form-group address">
                           <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                              ...
                              <select id="resState" name="resState" class="form-control address">
                                 ...
                                 <option value = "<?php echo $item ?>" <?php echo ($update && $item == $row['resState']) ? 'selected' : ((isset($_POST['resState']) && $item == $_POST['resState']) ? 'selected' : ''); ?> ><?php echo $item ?></option>
                                 <?php 
                                    } ?>
                              </select>
                           ...
                           <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                              ...
                              <select id="ofcState" name="ofcState" class="form-control address">
                                 <option value="0">Select State</option>
                                 <?php foreach($stateList as $key => $item){?>
                                 <option value = "<?php echo $item ?>" <?php echo ($update && $item == $row['ofcState']) ? 'selected' : ((isset($_POST['ofcState']) && $item == $_POST['ofcState']) ? 'selected' : ''); ?> ><?php echo $item ?></option>
                                 <?php 
                                    } ?>
                              </select>
                              </select>
