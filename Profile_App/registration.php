                     ...
                     <div class="well">
                        ...
                        <div class="row form-group">
                           ...
                           <div class="col-lg-1 col-md-1 col-sm-2 col-xs-12">
                              <input type="text" name = "title" class="form-control" id="inputTitle" placeholder="Mr/Ms">
                           </div>
                        ...
                        <div class="row form-group">
                           ...
                           <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                              <input id="textinput" name="email" type="text" placeholder="name@email.com" class="form-control input-md">
                           </div>
                        </div>
                        <!-- phone number input-->
                        <div class="row form-group">
                           ...
                           <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                              <input id="number" name="phone" type="text" placeholder="9999999999" class="form-control input-md">
                           </div>
                        </div>
                     ...
                     <div class="well">
                        ...
                        <div class="row form-group address">
                           <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                              ...
                              <!--Street Name-->
                              <input id="Address" name="resStreet" type="text" placeholder="Street" class="form-control input-md address">
                              <!-- City-->
                              <input id="city" name="resCity" type="text" placeholder="city" class="form-control input-md address">
                              <!-- ZIp -->
                              <input id="zip" name="resZip" type="text" placeholder="Zip" class="form-control input-md address">
                              <!-- Select State -->
                           ...
                           <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                              ...
                              <!--Street Name-->
                              <input id="OfcAddress" name="ofcAddress" type="text" placeholder="Street" class="form-control input-md address">
                              <!-- City-->                          
                              <input id="OfcCity" name="ofcCity" type="text" placeholder="city" class="form-control input-md address">
                              <!-- Zip-->
                              <input id="OfcZip" name="ofcZip" type="text" placeholder="Zip" class="form-control input-md address">
                              <!-- Select State -->
                     ...
                     <div class="well">
                           ...
                           <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                              <div class="row">
                                 <div class="radio col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <label><input type="radio" name="empStatus" checked="checked" value="employed">Employed</label>
                                 </div>
                                 <div class="radio col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <label><input type="radio" name="empStatus" value="umemployed">Umemployed</label>
                                 </div>
                              </div>
                              <div class="row">
                                 <div class="radio col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <label><input type="radio" name="empStatus" value="self-employed">Self-Employed</label>
                                 </div>
                                 <div class="radio col-lg- col-md-6 col-sm-6 col-xs-12">
                                    <label><input type="radio" name="empStatus" value="student">Student</label>
                                 </div>
                              </div>
                           </div>
                           </div>
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">                     
                              <textarea class="form-control" id="Note" name="note" rows="6" placeholder="Write something about yourself"></textarea>
                           </div>
                        </div>
